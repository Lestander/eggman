...
class oO0ooOO ( xbmcgui . WindowXMLDialog ) :
 ...
 def playVideo ( self , function = "true" ) :
  ...
  if xbmc . getCondVisibility ( 'System.HasAddon(script.system.settings)' ) and xbmcaddon . Addon ( id = "script.system.settings" ) . getSetting ( "OEM_DIST" ) in [ "Eggman" , "MBOX" ] : i11IiIIi11I = True ; self . analytics_video = "Eggman - No video played" ;
